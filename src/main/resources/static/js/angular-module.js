...
app.controller('DemoAppController', function($http, $location, $uibModal) {
    ...
    demoApp.getGreeting = () => $http.get("greeting")
            ...
            demoApp.test = Object.keys(response.data);
            demoApp.test.id = "1";
            console.log("test: " + demoApp.test);
//            demoApp.greeting = Object.keys(response.data)
//                .map((key) => response.data[key])
//                .reverse()
//                console.log("hier " + demoApp.greeting)
//                });
            demoApp.greeting = response.data;
            console.log(demoApp.greeting);
            console.log(typeof(demoApp.greeting))
            });
    ...
    demoApp.getGreeting()
    console.log("Hi beutiful" + demoApp.greeting);
    demoApp.getIOUs();
    demoApp.getMyIOUs();
});
